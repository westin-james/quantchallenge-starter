...
from src.train import train_best_models, get_importances_for_fitted
from src.predict import predict_submission
from src.config import FEATURE_COLS, MODEL_KEYS
...
def main():
    ...
    fitted_by_target = train_best_models(X_train, y_by_target, selections)
    importances = get_importances_for_fitted(fitted_by_target, FEATURE_COLS)
    ...
    plot_cv_summary(cv_long, summary, importances)
